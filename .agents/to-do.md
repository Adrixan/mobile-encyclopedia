...
## Sprint History & Completed Stories (All Done)

- [x] **US1.1: Configurable Vault Directory & Disk Space Inspection** (3 pts) — PASS
- [x] **US2.1: Master YAML Resource Catalog & Schema Validator** (5 pts) — PASS
- [x] **US3.1: Resumable Multi-backend Downloader with Verification** (5 pts) — PASS
- [x] **US4.1: Interactive Textual TUI & Storage Budget Calculator** (5 pts) — PASS
- [x] **US5.1: CLI Automation & Kiwix / Kolibri / Static Server Integration** (3 pts) — PASS
- [x] **US6.1: Dynamic Version Resolution, Canonical Versionless Naming & Safe Atomic Pruning** (5 pts) — PASS
...
- [x] **Git Status**: Working tree clean, all commits pushed to `origin/main`.
